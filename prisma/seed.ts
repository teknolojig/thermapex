...
async function main() {
  ...
  const ciftliKategori = await prisma.categories.upsert({
    ...
    create: {
      ...
      image: '/images/categories/ciftli.jpg',
      order: 1,
      active: true,
      updatedAt: new Date(),
    },
  ...
  const tekliKategori = await prisma.categories.upsert({
    ...
    create: {
      ...
      image: '/images/categories/tekli.jpg',
      order: 2,
      active: true,
      updatedAt: new Date(),
    },
  ...
  console.log('Kategoriler oluşturuldu:', { ciftliKategori, tekliKategori });
  ...
  for (let i = 0; i < ciftliUrunler.length; i++) {
    ...
    await prisma.products.upsert({
      ...
      create: {
        ...
        mainImage: '/images/products/ciftli-default.jpg',
        images: [],
        specifications: {
          marka: 'THERMAPEX',
  ...
  for (let i = 0; i < tekliUrunler.length; i++) {
    ...
    await prisma.products.upsert({
      ...
      create: {
        ...
        mainImage: '/images/products/tekli-default.jpg',
        images: [],
        specifications: {
          marka: 'THERMAPEX',
  ...
  console.log('Ürünler oluşturuldu: 21 ürün');
